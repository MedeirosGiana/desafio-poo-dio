...
public class Dev {
    private String nome;
    private Set<Conteudo> conteudosIncritos = new LinkedHashSet<>();//LinkedHashSet<>(adiciona elementos únicos
    private Set<Conteudo> conteudosConcluidos = new LinkedHashSet<>();

    //criando os métodos/ações
    ...
    public void progredir(){
        Optional<Conteudo> conteudo = this.conteudosIncritos.stream().findFirst();//pega em ordem
